...
function Add() {
  ...
  useEffect(() => {
    if (id) {
      const index = stdCtx.list.findIndex(
  ...
  return (
    <form className="w3-container" onSubmit={doRegister}>
      <div className="w3-panel w3-round-small w3-teal">
        <h3>
          <span>{id ? "Student Registration" : "Student Update"}</span>
      ...
      <label className="w3-text-blue">
        <i className="w3-medium custom-icon fa fa-user"></i>
        <b>First Name</b>
      </label>
      <input
      ...
      />
      {error.first_name ? (
        <div className="w3-panel w3-red">Please enter minimum 3 characters</div>
      ) : null}
      ...
      <label className="w3-text-blue">
        <i className="w3-medium custom-icon fa fa-phone"></i>
        <b>Phone</b>
      </label>
      <input
        className="w3-input w3-border"
      ...
      />
      {error.phone ? (
        <div className="w3-panel w3-red">Please enter valid phone number</div>
      ) : null}
      <br />
