  ...
  return (
    <div className="w3-container">
      ...
      <span className="search_panel">
        ...
        {search ? (
          <i
            className="w3-medium fa fa-close search_back"
            onClick={() => {
              setSearch("");
            }}
          ></i>
        ...
        <div className="w3-panel w3-light-grey w3-padding-16 w3-card-2">
          <table className="w3-table w3-striped w3-bordered">
            <thead>
              <tr>
                <th>
                  <i className="w3-medium custom-icon fa fa-refresh"></i> Sr.
                  No.
                </th>
                <th>
                  <i className="w3-medium custom-icon fa fa-user"></i> First
                  Name
                </th>
                <th>
                  <i className="w3-medium custom-icon fa fa-user"></i> Last Name
                </th>
                <th>
                  <i className="w3-medium custom-icon fa fa-envelope-o"></i>{" "}
                  Email
                </th>
                <th>
                  <i className="w3-medium custom-icon fa fa-phone"></i> Phone
                </th>
                <th>
                  <i className="w3-medium custom-icon fa fa-pencil"></i> Update
                </th>
                <th>
                  <i className="w3-medium custom-icon fa fa-trash"></i> Delete
                </th>
              </tr>
            </thead>
            <tbody>
              {searchStd(stdCtx.list).map((student, i) => {
                return (
                  <tr key={i} onClick={() => goToDetail(student.id)}>
                    <td>{i + 1}</td>
